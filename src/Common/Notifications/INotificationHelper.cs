...
namespace Bastille.Id.Api.Common.Notifications
{
    ...
    public interface INotificationHelper
    {
        ...
        Task NotifyUserAsync<TModel>(NotificationModel<TModel, string> notification, ApplicationContext<ApplicationDbContext> appContext = null, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">Contains an optional cancellation token.</param>
        /// <returns>Returns a task.</returns>
        Task NotifyAllAsync<TModel>(NotificationModel<TModel, string> notification, ApplicationContext<ApplicationDbContext> appContext = null, bool excludeCurrentUser = false, CancellationToken cancellationToken = default);
    }
}